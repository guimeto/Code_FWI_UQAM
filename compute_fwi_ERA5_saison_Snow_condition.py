...
for year in range(yi,yf+1):
    ...
    file = '/snow3/dueymes/REANALYSES/ERA5/UU_VV_TC/ERA5_TC_WIND_'+str(year)
    ...
    # ecriture du Netcdf
    data_set.to_netcdf('/snow3/dueymes/REANALYSES/ERA5/FWI_INDICES/FWI/ERA5_FWI_QC_SNOW_New_'+str(year)+'_from_'+str(dtime[0].month)+'_to_'+str(dtime[nt].month)+'.nc')
